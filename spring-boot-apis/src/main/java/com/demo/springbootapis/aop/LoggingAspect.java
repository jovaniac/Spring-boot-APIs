...
public class LoggingAspect {
	...
	@Pointcut("within(com.demo.springbootapis.controller.*) ||" + " within(com.demo.springbootapis.repository.*) ||"
			+ " within(com.demo.springbootapis.service.*) ||" + " within(com.demo.springbootapis.util.*)")
